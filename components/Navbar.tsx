...
export function Navbar() {
  ...
  const totalMarkets = bets?.length || 0;
  const resolvedMarkets = bets?.filter((bet) => bet.has_resolved).length || 0;
  const pendingMarkets = totalMarkets - resolvedMarkets;
          ...
          >
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-lg md:text-xl font-bold ml-2">Crypto Market
                </span>
              </div>

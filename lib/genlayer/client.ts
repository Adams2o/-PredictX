...
export function getContractAddress(): string {
  return process.env.NEXT_PUBLIC_CONTRACT_ADDRESS || "0x9d05eE47A6022357D83C96b74745fA1F63d02A55";
}
...
export async function switchAccount(): Promise<string> {
  ...
  try {
    ...
    else if (error.code === -32002) throw new Error("Account switch request already pending");
